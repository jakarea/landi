...
@section('title', '403 - অ্যাক্সেস নিষিদ্ধ')
@section('description', 'দুঃখিত, এই পেজটি দেখার অনুমতি আপনার নেই।')
    ...
    <div class="container-x relative z-10 py-20 lg:py-32">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="font-normal text-base md:text-lg text-[#ABABAB] leading-[160%] mb-8 lg:mb-12 max-w-xl mx-auto">
                দুঃখিত, এই পেজটি দেখার অনুমতি আপনার নেই। আপনার যদি মনে হয় এটি একটি ভুল, তাহলে অনুগ্রহ করে লগইন করুন বা সাপোর্টের সাথে যোগাযোগ করুন।
            </p>

            <!-- Action Buttons -->
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                @guest
                <a href="{{ route('login') }}" class="inline-flex font-golos justify-center items-center bg-submit border border-[#9F93A7]/70 hover:!bg-lime rounded-lg px-8 py-3 font-medium text-base lg:text-lg text-[#fff] anim hover:text-primary group">
            ...
            <div class="mt-12 lg:mt-16 pt-8 border-t border-[#232323]">
                <p class="text-[#ABABAB] text-sm">
                    সাহায্য প্রয়োজন? 
                    <a href="{{ route('contact') }}" class="text-[#E850FF] hover:text-[#4941C8] transition-colors underline">
