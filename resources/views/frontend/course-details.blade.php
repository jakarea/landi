...
@section('style')
    ...
    <link href="{{ asset('assets/admin-css/header.css') }}" rel="stylesheet" type="text/css" />
                                ...
                                @else
                                    @if (isEnrolled($course->id))
                                        <a href="{{ url('student/courses/' . $course->slug) }}" class="common-bttn"
                                            style="border-radius: 6.25rem; margin-top: 2rem"><img
                                                src="{{ asset('assets/images/icons/play-circle.svg') }}"
            ...
            <div class="row">
                <div class="col-lg-8 col-12 order-2 order-lg-1">
                    ...
                    <div class="review-box-wrap">
                        <form action="{{ route('students.review.courses', ['id' => $course->id, 'subdomain' => config('app.subdomain')]) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select name="star" id="rating" class="form-control">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (event) {
                ...
                var commentContent = quill.root.innerHTML;

                // Check if the content is just the placeholder paragraph
                if (commentContent === '<p><br></p>' || commentContent === '<p></p>') {
                    commentInput.value = '';
                } else {
