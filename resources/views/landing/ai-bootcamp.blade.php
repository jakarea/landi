  ...
  <!-- Tailwind CSS -->
    ...
    <style>
      ...
      * {
      ...
      button, a, .cursor-pointer, .hero-image-wrap {
        pointer-events: auto !important;
        position: relative;
        z-index: 10;
      }
...
<body class="bg-[#0A0A0A]">
  ...
  <section class="w-full pt-12 pb-20 first-gradient relative overflow-hidden border-b border-[#fff]/10 xl:py-[188px]">
    ...
    <div class="absolute inset-0 grid-background opacity-[7%] z-10" style="pointer-events: none;"></div> <!-- line elements -->

    <img src="/images/section-one-shadow.svg" class="absolute inset-0 left-0 top-0 w-full h-full z-30" alt="shadow" style="pointer-events: none;">
    ...
    <div class="container-x">
      <div class="w-full grid grid-cols-1 lg:grid-cols-2 lg:gap-x-20 xl:gap-x-[105px] lg:items-center">
        <div class="w-full">
          ...
          <div class="text-center relative z-40 lg:text-start">
            ...
            <div class="w-full lg:flex lg:items-center lg:gap-x-[30px] lg:mt-[30px]">
              ...
              <button type="button" onclick="scrollToEnrollmentForm(); return false;" class="inline-flex font-golos justify-center items-center bg-submit rounded-[10px] p-1.5 font-medium text-sm text-[#fff] pl-4 gap-x-2.5 anim
        ...
        <div class="text-center relative z-40 mt-7 lg:max-w-[90%] lg:mt-0">
           <div class="hero-image-wrap p-0 relative cursor-pointer" onclick="openVideoModal('https://www.youtube.com/embed/tA0hYGfKSRc?autoplay=1'); return false;" style="pointer-events: auto !important; z-index: 100 !important;">
              ...
              <div class="absolute left-0 top-0 w-full h-full flex items-center justify-center">
                <button type="button" onclick="openVideoModal('https://www.youtube.com/embed/tA0hYGfKSRc?autoplay=1'); return false;"
    ...
    <div class="container-x">
      ...
      <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 lg:gap-y-0 xl:gap-x-[45px]">
        ...
        <div class="rounded-[10px] p-[30px] bg-black ai-card text-center min-h-[318px]">
          ...
          <p class="common-para text-secondary-200 lg:!text-[15px] lg:leading-[150%]">বাংলাদেশ ও বিশ্বজুড়ে বিজ্ঞাপনে AI এর প্রভাব,
        ...
        <div class="rounded-[10px] p-[30px] bg-card ai-card ai-card-variant text-center min-h-[318px]">
          ...
          <p class="common-para text-secondary-200 lg:!text-[15px] lg:leading-[150%]">ভিডিও প্রম্পট তৈরি, প্রম্পট থেকে ভিডিও, ইমেজ থেকে
        ...
        <div class="rounded-[10px] p-[30px] bg-card ai-card text-center min-h-[318px]">
          ...
          <p class="common-para text-secondary-200 lg:!text-[15px] lg:leading-[150%]">AI দিয়ে জিঙ্গল, ব্যাকগ্রাউন্ড স্কোর, গান, ভয়েসওভার
          ...
          <div class="flex flex-col gap-y-2.5 lg:gap-y-6">
            ...
            <div
              ...
              <button type="button" class="col-span-2 flex justify-end">
                <img src="/images/icons/angle-down-circle.svg" alt="angle 1" class="w-5 lg:w-[30px]">
              </button>
            </div>
            <!-- card -->
            <!-- card -->
            <div
              ...
              <button type="button" class="col-span-2 flex justify-end">
                <img src="/images/icons/angle-down-circle.svg" alt="angle 2" class="w-5 lg:w-[30px]">
              </button>
            </div>
            <!-- card -->
            <!-- card -->
            <div
              ...
              <button type="button" class="col-span-2 flex justify-end">
                <img src="/images/icons/angle-down-circle.svg" alt="angle 3" class="w-5 lg:w-[30px]">
              </button>
            </div>
            <!-- card -->
          </div>
      ...
      <div class="w-full grid grid-cols-12 gap-5">
        ...
        <div class="w-full col-span-12 md:col-span-6 lg:col-span-4 grid grid-cols-12 gap-5">
          ...
          <div class="w-full relative col-span-12">
            <img src="/images/project-01.png" alt="project-01" class="w-full rounded-[10px] project-image">
            <p
          ...
          <div class="w-full relative col-span-8 lg:col-span-6">
            <div class="w-full relative mb-5">
              <img src="/images/project-04.png" alt="project-04" class="w-full rounded-[10px] project-image">
              <p
                class="rounded-full py-1 px-2 lg:py-2 lg:px-4 bg-[#fff]/20 text-[#fff] text-xs md:textbase lg:text-xl absolute bottom-2 left-2 lg:bottom-6 lg:left-6">
                Ai Image</p>
            </div>
            <div class="w-full relative hidden lg:block">
              <img src="/images/project-06.png" alt="project-04" class="w-full rounded-[10px] project-image">
              <p
                class="rounded-full py-1 px-2 lg:py-2 lg:px-4 bg-[#fff]/20 text-[#fff] text-xs md:textbase lg:text-xl absolute bottom-2 left-2 lg:bottom-6 lg:left-6">
                Ai monalisa</p>
            </div>
          ...
          <div class="w-full relative col-span-4 lg:col-span-6">
            <div class="w-full relative">
              <img src="/images/project-05.png" alt="project-04" class="w-full rounded-[10px] project-image">
              <p
                class="rounded-full py-1 px-2 lg:py-2 lg:px-4 bg-[#fff]/20 text-[#fff] text-xs md:textbase lg:text-xl absolute bottom-2 left-2 lg:bottom-6 lg:left-6">
                Ai Music</p>
            </div>
  ...
  <section class="w-full py-20">
    <div class="container-x">
      ...
      <!-- achovement -->
      <div class="w-full grid grid-cols-1 lg:grid-cols-3 lg:divide-x lg:divide-[#fff]/20 bg-card rounded-[10px] bg-all">
        <!-- card -->
        <div
  ...
  <section class="w-full py-20 relative bg-instructor">
    <div class="absolute inset-0 grid-background opacity-[13%] z-10" style="pointer-events: none;"></div> <!-- line elements, animate-pulse -->
    <div class="container-x">
      <!-- common title start -->
      <div class="text-center flex justify-center items-center flex-col mb-8 lg:mb-16 xl:mb-20">
        <div
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div class="w-full flex flex-col gap-y-6">
            ...
            <div class="w-full bg-[#0A0A0A] rounded-[10px] p-5 shadow-2 anim hover:bg-[#141414] group">
              <span class="flex items-center justify-center w-10 h-10 rounded-full bg-quote p-1 anim group-hover:bg-qute-hvr">
  ...
  <section class="w-full py-10 lg:py-20 bg-faq">
    <div class="container-x">
      ...
      <div class="w-full grid grid-cols-1 gap-y-1 lg:gap-y-2">
        <!-- card -->
        <div
          class="faq-item item bg-transparent rounded-[10px] p-2.5 grid grid-cols-12 items-center lg:items-start gap-x-2.5 md:p-3.5 lg:p-5 border border-[#49484E] faq-card-glow active"
          ...
          <div class="w-full col-span-10">
            ...
            <p class="faq-answer text-sm text-secondary-200 lg:text-base active">আমি একজন ডিজাইনার। আগে ডিজাইন করতে ঘন্টার পর ঘন্টা
          ...
          <button type="button" class="col-span-2 flex justify-end cursor-pointer">
            <img src="/images/icons/angle-down-circle.svg" alt="angle 1" class="w-5 lg:w-[26px] faq-icon">
          </button>
        </div>
        <!-- card -->
        <!-- card -->
        <div
          class="faq-item item bg-transparent rounded-[10px] p-2.5 grid grid-cols-12 items-center lg:items-start gap-x-2.5 md:p-3.5 lg:p-5 border border-[#49484E] faq-card-glow faq-card-glow-variant"
          onclick="toggleFAQ(this)">
          <div class="w-full col-span-10">
            ...
            <p class="faq-answer text-sm text-secondary-200 lg:text-base">এই কোর্সটি ৩ দিনের জন্য ডিজাইন করা হয়েছে। প্রতিদিন ২-৩ ঘন্টা করে লাইভ ক্লাস থাকবে। ক্লাসগুলো জুম প্ল্যাটফর্মে অনুষ্ঠিত হবে এবং সব ক্লাসের রেকর্ডিং পাবেন যাতে পরে আবার দেখতে পারেন।
            </p>
          </div>
          <button type="button" class="col-span-2 flex justify-end cursor-pointer">
            <img src="/images/icons/angle-down-circle.svg" alt="angle 1" class="w-5 lg:w-[26px] faq-icon">
        ...
        <!-- card -->
        <div
          class="faq-item item bg-transparent rounded-[10px] p-2.5 grid grid-cols-12 items-center lg:items-start gap-x-2.5 md:p-3.5 lg:p-5 border border-[#49484E] faq-card-glow"
          onclick="toggleFAQ(this)">
          <div class="w-full col-span-10">
            <h5 class="text-[#E2E8F0] font-medium text-lg md:text-xl lg:text-2xl">কোর্স ফি কত এবং কি কোনো লুকানো চার্জ
              আছে?</h5>

            <p class="faq-answer text-sm text-secondary-200 lg:text-base">কোর্স ফি মাত্র ৫,৩২০ টাকা। কোনো লুকানো চার্জ নেই। একবার পেমেন্ট করলেই সমস্ত কন্টেন্ট, লাইভ ক্লাস, রেকর্ডেড ক্লাস, এবং সাপোর্ট পাবেন। তাছাড়া বিকাশ, নগদ অন ডেলিভারি সুবিধাও পাবেন।
            </p>
          </div>
          <button type="button" class="col-span-2 flex justify-end cursor-pointer">
            <img src="/images/icons/angle-down-circle.svg" alt="angle 1" class="w-5 lg:w-[26px] faq-icon">
        ...
        <div
          ...
          <div class="w-full col-span-10">
            ...
            <p class="faq-answer text-sm text-secondary-200 lg:text-base">হ্যাঁ, কোর্স সম্পন্ন করার পর আপনার একটি ভেরিফাইড সার্টিফিকেট পাবেন যা আপনার LinkedIn এ শেয়ার করতে পারবেন অথবা চাকরির ইন্টারভিউতে দেখাতে পারবেন। তাছাড়া প্রজেক্ট পোর্টফোলিও পাবেন।
            </p>
          </div>
          <button type="button" class="col-span-2 flex justify-end cursor-pointer">
            <img src="/images/icons/angle-down-circle.svg" alt="angle 1" class="w-5 lg:w-[26px] faq-icon">
        ...
        <div
          ...
          <div class="w-full col-span-10">
            ...
            <p class="faq-answer text-sm text-secondary-200 lg:text-base">বিলকুল! এই কোর্সটি সম্পূর্ণভাবে বিগিনার-ফ্রেন্ডলি। আমরা সমস্ত টুলস এবং প্রক্রিয়া শূন্য থেকে শেখাবো। কোনো পূর্ব অভিজ্ঞতার প্রয়োজন নেই। প্রতিটি লেসন স্টেপ-বাই-স্টেপ সহজ ভাষায় করা হয়েছে।
            </p>
          </div>
          <button type="button" class="col-span-2 flex justify-end cursor-pointer">
            <img src="/images/icons/angle-down-circle.svg" alt="angle 1" class="w-5 lg:w-[26px] faq-icon">
        ...
        <div
          ...
          <div class="w-full col-span-10">
            ...
            <p class="faq-answer text-sm text-secondary-200 lg:text-base">এই কোর্স শেষে আপনি প্রফেশনাল মানের বিজ্ঞাপন, সোশ্যাল মিডিয়া কন্টেন্ট, প্রডাক্ট ভিজুয়াল, ভিডিও তৈরি, মিউজিক এবং ভয়েসওভার তৈরি করতে পারবেন। ফ্রিল্যান্সার হিসেবে কাজ করতে পারবেন অথবা নিজের বিজনেসের জন্য ব্যবহার করতে পারবেন।
            </p>
          </div>
          <button type="button" class="col-span-2 flex justify-end cursor-pointer">
            <img src="/images/icons/angle-down-circle.svg" alt="angle 1" class="w-5 lg:w-[26px] faq-icon">
  ...
  <section class="w-full py-10 lg:py-20 border-t border-[#fff]/20">
    <div class="container-x">
      <div class="w-full bg-card/80 rounded-[10px] py-5 px-6 flex flex-col lg:flex-row justify-center items-center text-center lg:justify-between border border-[#49484E]/50">
      ...
      <div class="w-full bg-card/80 rounded-[10px] py-5 px-4 mt-10 divide-y lg:divide-x lg:divide-y-0 divide-[#fff]/10 lg:p-10 lg:mt-12 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-10 border border-[#49484E]/50">
        <div class="left pb-10 lg:pb-0">
          <h3 class="text-center font-medium text-2xl text-[#fff] lg:text-start lg:text-[32px]">এখনই সহজে পেমেন্ট করুন</h3>
          ...
          <h4 class="mt-10 font-medium text-base white-70 text-center mb-2.5 lg:mt-[60px] lg:text-xl lg:text-start">এই নম্বরে পেমেন্ট করুন</h4>
          ...
          <div class="flex bg-[#011330] justify-between items-center max-w-[80%] rounded-[4px] mx-auto p-1.5 pl-4 lg:mx-0 lg:mr-auto lg:max-w-[46%] lg:rounded-lg">
            ...
            <button type="button" onclick="copyPhoneNumber(); return false;" class="bg-[#0B2042] rounded-[2px] py-2 px-3 font-normal text-xs text-blue lg:text-sm anim hover:bg-orange hover:text-primary cursor-pointer anim animate-pulse z-50 pointer-events-auto"
          ...
          <ul class="mt-2.5 flex flex-col gap-y-1">
            ...
            <li class="flex items-center gap-x-2">
              <span class="w-[2px] h-[2px] block bg-[#D9D9D9] lg:w-[3px] lg:h-[3px]"></span>
              <p class="text-sm font-normal text-[#ABABAB] lg:text-base">
                টাকা ফেরতযোগ্য নয়, সমস্যায় <a href="#" class="text-orange underline">সাপোর্টে যোগাযোগ করুন।</a>
              </p>
            </li>
          </ul>
        </div>
        <div class="right pt-10 lg:pt-0">
          <h5 class="font-medium text-base white-70 text-center mb-2.5 lg:text-lg lg:text-start">আপনার পেমেন্ট করা মাধ্যমটি বেছে নিন</h5>

          <!-- Error and Success Messages -->
          @if(session('success'))
            <div class="bg-green-600/30 border-2 border-green-400 text-green-300 p-5 rounded-xl mb-6 animate-pulse shadow-lg">
          ...
          @if(session('error'))
            <div class="bg-red-600/30 border-2 border-red-400 text-red-300 p-5 rounded-xl mb-6 animate-bounce shadow-lg">
                ...
                <div class="flex-1">
                  ...
                  <div class="space-y-2">
                    @foreach($errors->all() as $error)
                      <div class="flex items-start bg-red-800/30 border border-red-500/50 rounded-lg p-3">
                        <i class="fas fa-times-circle text-red-400 mr-2 mt-0.5"></i>
                        <p class="text-red-200 text-sm">
                          @if(str_contains(strtolower($error), 'email'))
                            <strong>ইমেইল সমস্যা:</strong> এই ইমেইল ঠিকানা দিয়ে ইতিমধ্যে একটি অ্যাকাউন্ট রয়েছে! অন্য ইমেইল ব্যবহার করুন।
                          @else
                            {{ $error }}
                          @endif
                        </p>
          ...
          <form id="enrollment-form" action="{{ route('ai-bootcamp.enroll') }}" method="POST" class="block mt-5 lg:mt-3 lg:grid lg:grid-cols-12 lg:gap-x-5">
            @csrf
            <!-- Hidden Fields -->
            ...
            <div class="w-full mt-5 lg:col-span-6">
              <label for="name" class="font-medium text-base white-70 block w-full mb-2.5">আপনার নাম</label>
              <input type="text" name="name" id="name" placeholder="নাম" class="bg-[#000] h-[38px] rounded-sm px-4 w-full text-[#fff] font-medium text-base placeholder:text-gray-400" required>
            </div>
            <div class="w-full mt-5 lg:col-span-6">
              <label for="email" class="font-medium text-base white-70 block w-full mb-2.5">আপনার ইমেইল</label>
              <input type="email" name="email" id="email" placeholder="ইমেইল" class="bg-[#000] h-[38px] rounded-sm px-4 w-full text-[#fff] font-medium text-base placeholder:text-gray-400" required>
            </div>
            <div class="w-full mt-5 lg:col-span-6">
              <label for="phone" class="font-medium text-base white-70 block w-full mb-2.5">আপনার নম্বর</label>
              <input type="text" name="phone" id="phone" placeholder="নম্বর" class="bg-[#000] h-[38px] rounded-sm px-4 w-full text-[#fff] font-medium text-base placeholder:text-gray-400" required>
            </div>
            <div class="w-full mt-5 lg:col-span-6">
              <label for="transaction_id" class="font-medium text-base white-70 block w-full mb-2.5">পেমেন্ট ট্রানজেকশন ID</label>
              <input type="text" name="transaction_id" id="transaction_id" placeholder="ট্রানজেকশন ID" class="bg-[#000] h-[38px] rounded-sm px-4 w-full text-[#fff] font-medium text-base placeholder:text-gray-400">
            </div>

            <div class="w-full flex justify-center lg:col-span-12 lg:justify-end">
              <button type="submit" class="bg-submit hover:!bg-lime hover:text-primary py-2 px-4 font-medium text-base white-70 mt-5 anim cursor-pointer lg:text-xl lg:py-3.5 lg:px-6 rounded-[10px] ">কনফার্ম করুন</button>
            </div>
    ...
    <div class="container-x">
      <div class="w-full text-center lg:flex items-center justify-between border-t border-[#fff]/20 py-5 xl:py-10">
        ...
        <p class="font-semibold text-base text-[#ABABAB] lg:text-base">
            Another idea turned into reality by - <a target="_blank" href="https://giopio.com" class="font-semibold text-base text-[#ABABAB]">Giopio</a>
  ...
  <!-- Video Modal -->
  <div id="videoModal" class="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50 opacity-0 invisible transition-all duration-300 ease-in-out" style="display: none !important;">
    <div class="relative max-w-4xl w-full mx-4 md:mx-8 transform scale-95 transition-transform duration-300 ease-in-out">

      <!-- Close button -->
      <button id="closeModal" class="absolute -top-16 right-0 text-white hover:text-red-400 transition-colors duration-200 z-10 bg-black bg-opacity-50 rounded-full p-2 hover:bg-opacity-75">
      ...
      <div class="bg-gradient-to-br from-gray-900 to-black rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div class="relative bg-gray-800" style="height: 450px; width: 100%;">
          ...
          <!-- Loading indicator -->
          <div id="videoLoading" class="absolute inset-0 flex items-center justify-center bg-gray-900 rounded-2xl">
            <div class="text-center">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-cyan-500 p-4 text-white">
          ...
          <p class="text-blue-100 text-sm mt-1">Discover how AI can revolutionize your advertising strategy</p>
        </div>
      </div>
    </div>
  </div>
