                ...
                <div class="col-12 col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="lesson-edit-form-wrap course-content-box course-page-edit-box flex-column mt-2 align-items-start"
                        ...
                        <div class="title d-flex w-100 justify-content-between">
                            <div class="media">
                                <img id="audio-thumbnail" src="{{ asset('assets/images/icons/big-audio.svg') }}"
...
@endif
                            ...
                            <div class="form-group form-upload">
                                ...
                                <label for="file-input" id="upload-box">
                                    <img src="{{ asset('assets/images/icons/upload.svg') }}" alt="Bar"
                                    ...
                                    <div class="title d-flex w-100 justify-content-between">
                                        <div class="media">
                                            <img id="audio-thumbnail"
                                                src="{{ asset('assets/images/icons/file.svg') }}" alt="Audio"
