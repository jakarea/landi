                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="top-image-upload-box drag-drop-areaa" id="dragDropArea">
                        ...
                        <div id="uploadSection" class="{{ $course->sample_certificates ? 'd-none' : '' }}">
                            <input type="file" class="d-none" id="certificate" name="sample_certificates" accept="image/*,.pdf">
                            <label for="certificate" class="file-up-box">
                                ...
                                <p><label for="certificate">Click to upload</label> or drag and drop <br> SVG, PNG, JPG or PDF (max. 5MB)</p>
                            </label>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Note: Upload section click is handled by the native label[for="certificate"] behavior
