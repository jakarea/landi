    ...
    <style> 
        ...
        * {
        ...
        .certficate-content h5.badge {
            ...
            padding: 0px 3px;
            padding-bottom: 6px;
            background-image: url({{ asset('assets/images/certificate/one/curved-bg.png') }});
        }
        ...
        .name-box h1:before {
            ...
            background-image: url({{ asset('assets/images/certificate/one/left-arrow.png') }});  
        }
        ...
        .name-box h1:after {
            ...
            background-size: contain; 
            background-image: url({{ asset('assets/images/certificate/one/right-arrow.png') }}); 
...
<body> 
    ...
    <div class="main-wrapper">
        <div class="container" style="margin-top: 2rem">
            <div class="main-bg">
                <img src="{{ asset('assets/images/certificate/one/one.png') }}" alt="Certificate-bg"
            ...
            <div class="logo-area">
                ...
                @else 
                    <img src="{{ asset('assets/images/certificate/one/logo.png') }}" alt="Logo" class="img-fluid">
                @endif 
            </div>
            <div class="asset-area">
                <img src="{{ asset('assets/images/certificate/one/checkmark.png') }}" alt="CHK" class="img-fluid">
            </div>
            <div class="certficate-content">
                ...
                <div class="signature">
                    ...
                    @else 
                        <img src="{{ asset('assets/images/certificate/one/signature.png') }}" alt="Logo" class="img-fluid">
                    @endif
