    ...
    <div class="page-header">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1"><i class="fas fa-clock me-2"></i> অপেক্ষমাণ নথিভুক্তি</h2>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1">
                                                    <div class="btn-group" role="group">
                                                        <button class="btn btn-modern btn-approve btn-sm" onclick="showApproveModal({{ $enrollment->id }}, 'with_payment')">
                                                            <i class="fas fa-check-circle"></i> পেমেন্ট সহ অনুমোদন
                                                        </button>
                                                        <button class="btn btn-modern btn-success btn-sm" onclick="showApproveModal({{ $enrollment->id }}, 'without_payment')">
                                                            <i class="fas fa-gift"></i> ফ্রি অ্যাক্সেস
                                                        </button>
