...
<body class="bg-[#0A0A0A]">
  ...
  <section class="w-full pt-12 pb-20 first-gradient relative overflow-hidden border-b border-[#fff]/10 xl:py-[188px]">
    ...
    <div class="absolute inset-0 grid-background opacity-[7%] z-10"></div> <!-- line elements -->

    <img src="/images/section-one-shadow.svg" class="absolute inset-0 left-0 top-0 w-full h-full z-30" alt="shadow">
    ...
    <div class="container-x">
      <div class="w-full grid grid-cols-1 lg:grid-cols-2 lg:gap-x-20 xl:gap-x-[105px] lg:items-center">
        <div class="w-full">
          ...
          <div class="text-center relative z-40 lg:text-start">
            ...
            <div class="w-full lg:flex lg:items-center lg:gap-x-[30px] lg:mt-[30px]">
              ...
              <a href="#" class="inline-flex font-golos justify-center items-center bg-submit rounded-[10px] p-1.5 font-medium text-sm text-[#fff] pl-4 gap-x-2.5 anim
               hover:!bg-lime md:text-base lg:text-base lg:p-2.5 lg:pl-4.5 hover:text-primary group lg:my-0 lg:order-1 border border-[#9F93A7]/70">
                এখনই এনরোল করুন
                <span
        ...
        <div class="text-center relative z-40 mt-7 lg:max-w-[90%] lg:mt-0">
           <div class="hero-image-wrap p-0 relative">
    ...
    <div class="container-x">
      ...
      <div class="w-full grid grid-cols-1 lg:grid-cols-3 lg:divide-x lg:divide-[#fff]/20 bg-card rounded-[10px] bg-all">
        ...
        <div
          ...
          <img src="./public/images/icons/achivement-01.svg" alt="achivement 01" class="mx-auto lg:w-[77px]">
        ...
        <div class="bg-transparent text-center p-4 pb-14 lg:pb-4 lg:px-12 lg:py-24">
          <img src="./public/images/icons/achivement-02.svg" alt="achivement 01" class="mx-auto lg:w-[64px]">
        ...
        <div
          ...
          <img src="./public/images/icons/achivement-02.svg" alt="achivement 01" class="mx-auto lg:w-[57px]">
            ...
            <ul class="flex items-center justify-center gap-x-2.5 mt-2.5 lg:justify-start">
              <li>
                <a href="#" class="block w-[30px] h-[30px] rounded-full">
                  <img src="./public/images/icons/call.svg" alt="call" class="w-full">
                </a>
              </li>
              <li>
                <a href="#" class="block w-[30px] h-[30px] rounded-full">
                  <img src="./public/images/icons/mail.svg" alt="call" class="w-full">
                </a>
              </li>
              <li>
                <a href="#" class="block w-[30px] h-[30px] rounded-full">
                  <img src="./public/images/icons/linkedin.svg" alt="call" class="w-full">
                </a>
              </li>
              <li>
                <a href="#" class="block w-[30px] h-[30px] rounded-full">
                  <img src="./public/images/icons/facebook.svg" alt="call" class="w-full">
                </a>
              </li>
            </ul>
      ...
      <div class="w-full grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 lg:gap-x-12">
        ...
        <div class="text-center">
          <a href="#" class="flex justify-center">
            <img src="./public/images/clients/nagad.svg" alt="naagd" class="w-fit mx-auto">
          </a>
        </div>
        <!-- client -->
        <!-- client -->
        <div class="text-center">
          <a href="#" class="flex justify-center">
            <img src="./public/images/clients/prothomalo.svg" alt="prothomalo" class="w-fit mx-auto">
          </a>
        </div>
        <!-- client -->
        <!-- client -->
        <div class="text-center">
          <a href="#" class="flex justify-center">
            <img src="./public/images/clients/undp.svg" alt="undp" class="w-fit mx-auto">
          </a>
        </div>
        <!-- client -->
        <!-- client -->
        <div class="text-center">
          <a href="#" class="flex justify-center">
            <img src="./public/images/clients/square-food.svg" alt="square" class="w-fit mx-auto">
          </a>
        </div>
        <!-- client -->
        <!-- client -->
        <div class="text-center">
          <a href="#" class="flex justify-center">
            <img src="./public/images/clients/yamaha.svg" alt="yamaha" class="w-fit mx-auto">
          </a>
        </div>
        <!-- client -->
        <!-- client -->
        <div class="text-center">
          <a href="#" class="flex justify-center">
            <img src="./public/images/clients/ifad.svg" alt="ifad" class="w-fit mx-auto">
          </a>
        </div>
        <!-- client -->
      </div>
          ...
          <form class="block mt-5 lg:mt-3 lg:grid lg:grid-cols-12 lg:gap-x-5">
            <div class="flex w-full justify-between items-center gap-x-5 lg:justify-start lg:gap-x-6 lg:mb-[60px] lg:col-span-12">
              <label for="nagad" class="flex items-center  bg-card anim cursor-pointer px-2 gap-x-2 w-28 h-12">
                <input type="radio" name="payment" id="nagad" checked>
                <img src="./public/images/icons/nagad.svg" alt="nagad" class="max-w-20"> 
              </label>
              <label for="bkash" class="flex items-center  bg-card anim cursor-pointer px-2 gap-x-2 w-28 h-12">
                ...
                <img src="./public/images/icons/bkash.svg" alt="bkash" class="max-w-20"> 
              </label>
              <label for="rocket" class="flex items-center  bg-card anim cursor-pointer px-2 gap-x-2 w-24 h-12">
                ...
                <img src="./public/images/icons/rocket.svg" alt="rocket" class="max-w-[50px]"> 
              </label>
            </div>
            <div class="w-full mt-5 lg:col-span-6">
              ...
              <input type="text" name="name" id="name" placeholder="নাম" class="bg-[#000] h-[38px] rounded-sm px-4 w-full text-[#fff] font-medium text-base placeholder:text-gray-400">
            </div>
            <div class="w-full mt-5 lg:col-span-6">
              <label for="email" class="font-medium text-base white-70 block w-full mb-2.5">আপনার ইমেইল</label>
              <input type="email" name="email" id="email" placeholder="ইমেইল" class="bg-[#000] h-[38px] rounded-sm px-4 w-full text-[#fff] font-medium text-base placeholder:text-gray-400">
            </div>
            <div class="w-full mt-5 lg:col-span-6">
              <label for="number" class="font-medium text-base white-70 block w-full mb-2.5">আপনার নম্বর</label>
              <input type="text" name="number" id="number" placeholder="নম্বর" class="bg-[#000] h-[38px] rounded-sm px-4 w-full text-[#fff] font-medium text-base placeholder:text-gray-400">
            </div>
            <div class="w-full mt-5 lg:col-span-6">
              <label for="transaction" class="font-medium text-base white-70 block w-full mb-2.5">পেমেন্ট ট্রানজেকশন ID</label>
              <input type="text" name="transaction" id="transaction" placeholder="ট্রানজেকশন ID" class="bg-[#000] h-[38px] rounded-sm px-4 w-full text-[#fff] font-medium text-base placeholder:text-gray-400">
            </div>
