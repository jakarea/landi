...
@section('header-title', 'ব্লগ পোস্ট এডিট')
...
@section('content')
    <div class="p-8">
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <form action="{{ route('cms.ai-update.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <input 
                        ...
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    >
                    <p class="text-gray-600 text-xs mt-1">Preview: <span id="slug-preview" class="font-mono text-blue-600">/ai-update/{{ $blog->slug }}/</span></p>
                </div>
                ...
                @if($blog->thumbnail)
                    <div class="mb-4">
                        ...
                        <img src="{{ asset($blog->thumbnail) }}" alt="Current thumbnail" class="max-w-xs rounded shadow">
                    </div>
                @endif
                ...
                <div class="mb-6">
                    <label for="thumbnail" class="block text-gray-700 text-sm font-bold mb-2">
                        {{ $blog->thumbnail ? 'Change Thumbnail Image' : 'Thumbnail Image' }}
                    </label>
                    <input 
                        type="file" 
                        name="thumbnail" 
                ...
                <div class="flex items-center justify-between">
                    <div class="flex gap-4">
                        ...
                        <a href="{{ route('cms.ai-update.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-6 rounded">
                            Cancel
                        </a>
                    </div>
                </div>
