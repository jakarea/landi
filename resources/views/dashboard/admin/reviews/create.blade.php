...
@section('header-title', 'Add New Review')
...
@section('content')
    <div class="p-8">
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <form action="{{ route('cms.reviews.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="reviewer_designation" name="reviewer_designation" value="{{ old('reviewer_designation') }}" 
                ...
                <div class="mb-4">
                    <label for="reviewer_avatar" class="block text-gray-700 font-bold mb-2">Reviewer Avatar</label>
